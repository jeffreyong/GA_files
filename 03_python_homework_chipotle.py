...
with open('data/orders.tsv', 'rU') as f:
...
unique_order_id = set([row[0] for row in data])
unique_id_count = len(unique_order_id)
...
# $18.81
total_prices = sum(i for i in prices)

average_price_order = round((total_prices / order_ids[-1]), 2)
