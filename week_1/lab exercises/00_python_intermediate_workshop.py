...
# list of names
list_names = ["Jeff", "Wendy", "Jennifer", "Rueben", "Jenevieve"]
# last element
print list_names[-1]
# length of first string
print len(list_names[0])
# overwrite existing element
list_names[4] = "MeiMei"
print list_names
# append new element
list_names.append("Sophia")
# change last string to be lowercase
list_names[-1].lower()
# sort the list in reverse order
sorted(list_names, reverse=True)
# sort the list by length
sorted(list_names, key = len)
...
for letter in letters:
    letters_up.append(letter.upper())

print letters_up

word = 'abc'
# iterate through each character
new_list = list(word.upper())
print new_list
...
family['kids'] = [' '.join(name[0].upper() + name[1:] for name in family['kids'].split())]
